...
inject(function ($route) {
  ...
  expect($route.routes['/posts'].controller).toBe('PostsController');
  expect($route.routes['/posts'].templateUrl).toEqual('views/posts/main.html');

  expect($route.routes['/posts/create'].controller).toBe('PostsController');
  expect($route.routes['/posts/create'].templateUrl).toEqual('views/posts/form.html');

  expect($route.routes['/posts/:postId'].controller).toBe('PostsController');
  expect($route.routes['/posts/:postId'].templateUrl).toEqual('views/posts/show.html');

  expect($route.routes['/posts/:postId/edit'].controller).toBe('PostsController');
  expect($route.routes['/posts/:postId/edit'].templateUrl).toEqual('views/posts/form.html');


  expect($route.routes['/categories'].controller).toBe('CategoriesController');
  expect($route.routes['/categories'].templateUrl).toEqual('views/categories/main.html');

  expect($route.routes['/categories/create'].controller).toBe('CategoriesController');
  expect($route.routes['/categories/create'].templateUrl).toEqual('views/categories/form.html');

  expect($route.routes['/categories/:categoryId'].controller).toBe('CategoriesController');
  expect($route.routes['/categories/:categoryId'].templateUrl).toEqual('views/categories/show.html');

  expect($route.routes['/categories/:categoryId/edit'].controller).toBe('CategoriesController');
